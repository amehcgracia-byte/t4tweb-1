...
import { CAMPAIGN_TOUCHPOINTS } from "@/components/campaign-touchpoints"
...
export function LatestReleaseSection() {
  ...
  return (
    <section
      id="latest-release"
      data-campaign-touchpoint={CAMPAIGN_TOUCHPOINTS.latestRelease}
      className="relative py-14 md:py-16 bg-black/55"
    >
