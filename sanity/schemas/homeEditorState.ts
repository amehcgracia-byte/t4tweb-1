          ...
          fields: [
            ...
            defineField({
              ...
              fields: [
                ...
                defineField({ name: "textShadow", type: "string" }),
                defineField({ name: "borderColor", type: "string" }),
                defineField({ name: "borderWidth", type: "string" }),
                defineField({ name: "borderRadius", type: "string" }),
                defineField({ name: "boxShadow", type: "string" }),
                defineField({ name: "paddingLeft", type: "string" }),
                defineField({ name: "paddingRight", type: "string" }),
                defineField({ name: "objectFit", type: "string" }),
                defineField({ name: "objectPosition", type: "string" }),
            ...
            defineField({
              ...
              fields: [
                ...
                defineField({ name: "customKind", type: "string" }),
