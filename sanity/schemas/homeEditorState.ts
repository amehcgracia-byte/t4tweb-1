          ...
          fields: [
            ...
            defineField({
              ...
              fields: [
                ...
                defineField({ name: "gradientEnabled", type: "boolean" }),
                defineField({ name: "gradientStart", type: "string" }),
                defineField({ name: "gradientEnd", type: "string" }),
                ...
                defineField({ name: "locationUrl", type: "string" }),
              ],
            }),
